...
public:
	...
	Status DelQueue(BTreeNode<ElemType> *&e);				     // 出队操作
	Status GetHead(BTreeNode<ElemType> *&e) const;			     // 取队头操作
	Status EnQueue(const BTreeNode<ElemType> &e);			     // 入队操作
...
template<class ElemType>
Status LinkQueue<ElemType>::DelQueue(BTreeNode<ElemType> *&e)
...
template<class ElemType>
Status LinkQueue<ElemType>::GetHead(BTreeNode<ElemType> *&e) const
...
template<class ElemType>
Status LinkQueue<ElemType>::EnQueue(const BTreeNode<ElemType> &e)
